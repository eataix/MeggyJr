...
void            avr_thread_run_queue_push(volatile avr_thread * t);
#endif
...
void            avr_thread_sem_up(volatile avr_thread_semaphore * sem);

void            avr_thread_sem_down(volatile avr_thread_semaphore * sem);

avr_thread_rwlock * avr_thread_rwlock_init(void);
